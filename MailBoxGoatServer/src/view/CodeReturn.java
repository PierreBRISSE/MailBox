...
public class CodeReturn extends AbstractCodeReturn {

	public CodeReturn(List<Integer> codes, Logger logger) {
		super();
		super.setCodes(codes);
		super.setLogger(logger);
		super.setUnknown(false);
		super.setMessage(new Message(logger));
		super.setMessageError(new MessageError(logger));
	}
	...
	public void codesTranslation() {
		...
		super.logger.trace("Sever - " + CodeReturn.class);
	...
	private void codeTranslation(int code) {
		...
		// Message :
		case 60:
			messageError.problemWhenSplitingContent();
			break;

		case 61:
			messageError.problemNumberOfSplitContent();
			break;

		case 63:
			messageError.NoSeparatorContent();
			break;
